...
- [Columba](https://github.com/torlando-tech/columba) - Android messaging and voice client for the Reticulum network (LXMF/LXST) that connects over Bluetooth LE, Wi-Fi/TCP, or LoRa via RNode radios, and can bridge those interfaces so a local Bluetooth mesh extends across LAN or internet links; MPL-2.0 and Android-only, first released in late 2025. **Experimental**
